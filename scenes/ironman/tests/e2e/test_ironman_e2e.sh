...
ping -c1 -W2 203.0.113.50 > /dev/null 2>&1 && pass "TV accessible" || echo "[SKIP] TV hors reseau"
ping -c1 -W2 203.0.113.51 > /dev/null 2>&1 && pass "Hue accessible" || echo "[SKIP] Hue hors reseau"
