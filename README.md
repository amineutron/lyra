...
| Commandes hors règles, petit modèle | **21/21** sur le banc des modèles et **51/51** sur le jeu de formulations inédites (5 serveurs) avec `qwen2.5-coder:0.5b`, contre 5/21 et 13/51 avant la [boucle d'amélioration](docs/dev/BOUCLE_AMELIORATION.md) ; scores stricts 17/21 et 50/51 ([BENCHMARKS.md](BENCHMARKS.md), `make bench-modeles`). Sur un **quatrième jeu de 50 formulations tenu à l'écart** (jamais itéré, vrais noms de machines), la configuration finale fait **41/50** ; c'est la mesure de généralisation à retenir, les trois autres jeux ayant servi à la boucle (le troisième, 100 formulations, était à 56/100 avant les leviers génériques et à 82/100 après deux itérations dessus) |
